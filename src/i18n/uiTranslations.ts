...
const TRANSLATION_ROWS: TranslationRow[] = [
  ...
  ['What is Daily IXMetrics Intelligence?', 'IXMetrics デイリーインテリジェンスとは？', '¿Qué es la Inteligencia diaria de IXMetrics?', '일일 IXMetrics 인텔리전스란?', '什麼是 IXMetrics 每日情報？', 'O que é a Inteligência diária IXMetrics?', 'Was ist die tägliche IXMetrics-Analyse?'],
