...
const copy = {
  en: {
    ...
    dashboard: 'Dashboard', schedule: 'Schedule', matchups: 'Matchups + Game Logs', teamAnalysis: 'Team Analysis', scoutingFeed: 'Scouting Feed', highlights: 'Highlights', analytics: 'Analytics', playerPredictions: 'Player Predictions', community: 'Community', challenge: 'ScoutCore Challenge',
  ...
  ja: {
    ...
    dashboard: 'ダッシュボード', schedule: 'スケジュール', matchups: '対戦 + ゲームログ', teamAnalysis: 'チーム分析', scoutingFeed: 'スカウティングフィード', highlights: 'ハイライト', analytics: '分析', playerPredictions: '選手予測', community: 'コミュニティ', challenge: 'ScoutCore チャレンジ',
  ...
  es: {
    ...
    dashboard: 'Panel', schedule: 'Calendario', matchups: 'Enfrentamientos + registros', teamAnalysis: 'Análisis de equipos', scoutingFeed: 'Informe de scouting', highlights: 'Destacados', analytics: 'Análisis', playerPredictions: 'Predicciones de jugadores', community: 'Comunidad', challenge: 'Desafío ScoutCore',
  ...
  ko: {
    ...
    dashboard: '대시보드', schedule: '일정', matchups: '매치업 + 경기 기록', teamAnalysis: '팀 분석', scoutingFeed: '스카우팅 피드', highlights: '하이라이트', analytics: '분석', playerPredictions: '선수 예측', community: '커뮤니티', challenge: 'ScoutCore 챌린지',
  ...
  'zh-TW': {
    ...
    dashboard: '儀表板', schedule: '賽程', matchups: '對戰 + 比賽紀錄', teamAnalysis: '球隊分析', scoutingFeed: '球探動態', highlights: '精彩片段', analytics: '分析', playerPredictions: '球員預測', community: '社群', challenge: 'ScoutCore 挑戰',
