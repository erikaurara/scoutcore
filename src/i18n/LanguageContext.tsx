...
const copy = {
  en: {
    ...
    coreModules: 'Core Modules', account: 'Account', yourScoutLevel: 'Your Analyst Level', settings: 'Settings', unlockMore: 'Unlock More',
  ...
  ja: {
    ...
    coreModules: 'コア機能', account: 'アカウント', yourScoutLevel: 'あなたのアナリストレベル', settings: '設定', unlockMore: 'さらに利用する',
  ...
  es: {
    ...
    coreModules: 'Módulos principales', account: 'Cuenta', yourScoutLevel: 'Tu nivel de analista', settings: 'Ajustes', unlockMore: 'Desbloquear más',
  ...
  ko: {
    ...
    coreModules: '핵심 메뉴', account: '계정', yourScoutLevel: '내 분석가 레벨', settings: '설정', unlockMore: '더 보기',
  ...
  'zh-TW': {
    ...
    coreModules: '核心功能', account: '帳號', yourScoutLevel: '你的分析師等級', settings: '設定', unlockMore: '解鎖更多',
  ...
  'pt-BR': {
    ...
    coreModules: 'Módulos principais', account: 'Conta', yourScoutLevel: 'Seu nível de analista', settings: 'Configurações', unlockMore: 'Desbloquear mais',
  ...
  de: {
    ...
    coreModules: 'Hauptmodule', account: 'Konto', yourScoutLevel: 'Deine Analystenstufe', settings: 'Einstellungen', unlockMore: 'Mehr freischalten',
