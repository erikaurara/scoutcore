...
const copy = {
  en: {
    ...
    dashboard: 'Dashboard', schedule: 'Schedule', matchups: 'Matchup', matchupLab: 'Matchup Lab', teamAnalysis: 'Team Analysis', scoutingFeed: 'Insights Feed', highlights: 'Highlights', analytics: 'Analytics', playerPredictions: 'Player Predictions', community: 'Community', challenge: 'IX Challenge',
    coreModules: 'Core Modules', account: 'Account', yourScoutLevel: 'Your Analyst Level', settings: 'Settings', unlockMore: 'Unlock More', premiumAccess: 'Premium Access',
  ...
  ja: {
    ...
    dashboard: 'ダッシュボード', schedule: 'スケジュール', matchups: '対戦', matchupLab: '対戦ラボ', teamAnalysis: 'チーム分析', scoutingFeed: 'インサイトフィード', highlights: 'ハイライト', analytics: '分析', playerPredictions: '選手予測', community: 'コミュニティ', challenge: 'IX チャレンジ',
    coreModules: 'コア機能', account: 'アカウント', yourScoutLevel: 'あなたのアナリストレベル', settings: '設定', unlockMore: 'さらに利用する', premiumAccess: 'プレミアムアクセス',
  ...
  es: {
    ...
    dashboard: 'Panel', schedule: 'Calendario', matchups: 'Enfrentamiento', matchupLab: 'Laboratorio de enfrentamientos', teamAnalysis: 'Análisis de equipos', scoutingFeed: 'Feed de insights', highlights: 'Destacados', analytics: 'Análisis', playerPredictions: 'Predicciones de jugadores', community: 'Comunidad', challenge: 'Desafío IX',
    coreModules: 'Módulos principales', account: 'Cuenta', yourScoutLevel: 'Tu nivel de analista', settings: 'Ajustes', unlockMore: 'Desbloquear más', premiumAccess: 'Acceso Premium',
  ...
  ko: {
    ...
    dashboard: '대시보드', schedule: '일정', matchups: '맞대결', matchupLab: '맞대결 연구소', teamAnalysis: '팀 분석', scoutingFeed: '인사이트 피드', highlights: '하이라이트', analytics: '분석', playerPredictions: '선수 예측', community: '커뮤니티', challenge: 'IX 챌린지',
    coreModules: '핵심 메뉴', account: '계정', yourScoutLevel: '내 분석가 레벨', settings: '설정', unlockMore: '더 보기', premiumAccess: '프리미엄 이용',
  ...
  'zh-TW': {
    ...
    dashboard: '儀表板', schedule: '賽程', matchups: '對戰', matchupLab: '對戰實驗室', teamAnalysis: '球隊分析', scoutingFeed: '洞察動態', highlights: '精彩片段', analytics: '分析', playerPredictions: '球員預測', community: '社群', challenge: 'IX 挑戰',
    coreModules: '核心功能', account: '帳號', yourScoutLevel: '你的分析師等級', settings: '設定', unlockMore: '解鎖更多', premiumAccess: '進階版存取',
  ...
  'pt-BR': {
    ...
    dashboard: 'Painel', schedule: 'Agenda', matchups: 'Confronto', matchupLab: 'Laboratório de confrontos', teamAnalysis: 'Análise de times', scoutingFeed: 'Feed de insights', highlights: 'Destaques', analytics: 'Análises', playerPredictions: 'Previsões de jogadores', community: 'Comunidade', challenge: 'Desafio IX',
    coreModules: 'Módulos principais', account: 'Conta', yourScoutLevel: 'Seu nível de analista', settings: 'Configurações', unlockMore: 'Desbloquear mais', premiumAccess: 'Acesso Premium',
  ...
  de: {
    ...
    dashboard: 'Übersicht', schedule: 'Spielplan', matchups: 'Duell', matchupLab: 'Duell-Labor', teamAnalysis: 'Teamanalyse', scoutingFeed: 'Insights-Feed', highlights: 'Höhepunkte', analytics: 'Analysen', playerPredictions: 'Spielerprognosen', community: 'Gemeinschaft', challenge: 'IX-Challenge',
    coreModules: 'Hauptmodule', account: 'Konto', yourScoutLevel: 'Deine Analystenstufe', settings: 'Einstellungen', unlockMore: 'Mehr freischalten', premiumAccess: 'Premium-Zugang',
...
export const LanguageProvider: React.FC<React.PropsWithChildren> = ({ children }) => {
  ...
  const value = useMemo<LanguageContextValue>(() => ({
    locale,
    setLocale,
    t: (key) => applyBrandCopy(copy[locale][key] ?? copy.en[key], locale),
  }), [locale]);
