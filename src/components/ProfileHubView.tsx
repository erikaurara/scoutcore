        ...
        <section className="overflow-hidden rounded-2xl border border-[#2a405b] bg-[radial-gradient(circle_at_10%_5%,rgba(0,240,255,.17),transparent_30%),linear-gradient(120deg,#0a1d31,#0b1728_58%,#101a2d)] shadow-[0_12px_36px_rgba(0,0,0,.18)]">
          <div className="relative px-8 py-8">
            ...
            <div className="mt-6 grid grid-cols-3 overflow-hidden rounded-xl border border-[#2a405b] bg-[#0b1728]/78">
              ...
              <button onClick={() => void openSocial('friends')} className="flex items-center justify-center gap-3 border-r border-[#2a405b] px-4 py-4"><span className="material-symbols-outlined text-[27px] text-[#31e5ee]">groups</span><span><span className="block text-xs text-[#a5b1c1]">Friends</span><span className="block text-2xl font-black leading-none text-white">{counts.friends}</span></span></button>
              <button onClick={() => void openSocial('following')} className="flex items-center justify-center gap-3 px-4 py-4"><span className="material-symbols-outlined text-[27px] text-[#31e5ee]">person</span><span><span className="block text-xs text-[#a5b1c1]">Following</span><span className="block text-2xl font-black leading-none text-white">{counts.following}</span></span></button>
            </div>
          </div>
        </section>
