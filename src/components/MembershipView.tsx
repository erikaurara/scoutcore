...
export const MembershipView: React.FC<MembershipViewProps> = ({ onSignIn, signedIn }) => (
  <div className="p-8 max-w-6xl mx-auto">
    <div className="mb-7">
      <div className="text-[11px] uppercase tracking-[.22em] text-[#65f2b5]">ScoutCore Access</div>
      <h1 className="text-3xl font-bold mt-2">Scout for free. Sign up when you want more.</h1>
      <p className="text-sm text-[#9aabad] mt-2 max-w-2xl">No account is required to explore ScoutCore. Search players, check games and use the core baseball tools immediately. A free account unlocks personalized scouting features.</p>
    </div>

    <div className="grid md:grid-cols-2 gap-5">
      <div className="rounded-2xl border border-[#34425a] bg-[#151e32] p-6">
        <div className="flex justify-between items-start">
          <div><div className="text-xs uppercase text-[#9aabad]">Browse ScoutCore</div><div className="text-3xl font-bold mt-2">Free</div><div className="text-xs text-[#849495] mt-1">No account required</div></div>
      ...
      <div className="rounded-2xl border border-[#00f0ff]/45 bg-[#121f35] p-6 shadow-[0_0_30px_rgba(0,240,255,.08)] relative overflow-hidden">
        ...
        <div className="flex justify-between items-start">
          <div><div className="text-xs uppercase text-[#00f0ff]">ScoutCore Account</div><div className="text-3xl font-bold mt-2">Unlock More</div><div className="text-xs text-[#849495] mt-1">Still $0 · just create an account</div></div>
    ...
    <div className="mt-5 rounded-xl border border-[#3b494b]/30 bg-[#10192b] px-4 py-3 text-xs text-[#849495]">No premium subscription or payment is required. We can consider paid features later only if ScoutCore eventually has additional tools worth charging for.</div>
  </div>
);
