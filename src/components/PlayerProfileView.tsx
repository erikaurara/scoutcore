...
export const PlayerProfileView: React.FC<Props> = ({ playerId, onOpenTeam }) => {
  ...
  return <div className="px-3 pt-1 pb-1.5 sm:px-8 sm:py-8 max-w-[1280px] mx-auto h-[calc(100svh-96px)] sm:h-auto overflow-hidden sm:overflow-visible flex flex-col sm:block gap-1.5 sm:space-y-6">
    ...
    <section className="min-h-0 flex-1 sm:flex-none bg-[#171f33] border border-[#3b494b]/30 rounded-xl sm:rounded-2xl overflow-hidden flex flex-col">
      ...
      <div className="sm:hidden -mt-px min-h-0 flex-1 overflow-y-auto overscroll-contain bg-[#171f33] border-t border-[#3b494b]/25 [scrollbar-color:rgba(92,105,130,.32)_transparent] [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[#5c6982]/30">
