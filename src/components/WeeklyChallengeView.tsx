...
export const WeeklyChallengeView:React.FC<{onBack:()=>void}>=({onBack})=>{
  ...
  return <div className="min-h-screen bg-[#081225] px-4 py-5 text-[#dae2fd] sm:px-6 lg:px-8"><div className="mx-auto max-w-6xl">
    ...
    <div className="mt-6 flex flex-wrap items-end justify-between gap-3"><div className="text-sm font-black uppercase tracking-[.12em] text-[#59e8f3]">Weekly Leaderboard</div><div className="flex gap-2"><span className="rounded-full bg-[#59e8f3] px-4 py-2 text-xs font-black text-[#07101f]">OVERALL</span><span className="rounded-full border border-[#30445f] px-4 py-2 text-xs font-bold text-[#9fb0c5]">TOP 100</span></div></div>
