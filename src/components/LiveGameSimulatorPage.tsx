  ...
  return <div className="min-h-[calc(100vh-4rem)] bg-[#07101d] text-[#dae2fd]">
    <div className="border-b border-[#26364e] bg-[#08111f] px-3 py-2.5 sm:px-5">
      <div className="mx-auto flex max-w-[1740px] items-center justify-between gap-3">
        ...
        <div className="min-w-0 flex-1 text-center"><p className="truncate text-[10px] font-black uppercase tracking-[.15em] text-[#00e6f4]">IXMetrics AI Live Sim</p><p className="mt-0.5 truncate text-[9px] text-[#718198]">{game.awayTeam?.abbreviation ?? game.awayTeam?.name ?? 'Away'} @ {game.homeTeam?.abbreviation ?? game.homeTeam?.name ?? 'Home'} · separate live game page</p></div>
