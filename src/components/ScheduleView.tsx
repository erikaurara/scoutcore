...
export const ScheduleView: React.FC = () => {
  ...
  return <div className="min-h-screen bg-[#0b1326] text-[#dae2fd] p-8 space-y-6">
    ...
    {loading ? <div className="p-10 text-center text-[#849495] bg-[#171f33] rounded-xl">Loading MLB schedule…</div> : visibleGames.length === 0 ? <div className="p-10 text-center text-[#849495] bg-[#171f33] rounded-xl">No games match this filter.</div> : <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4">{visibleGames.map((game) => <GameCard game={game} />)}</div>}
