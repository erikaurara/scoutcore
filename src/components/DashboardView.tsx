...
const gameDestinationLabel = (game: MlbScheduleGame) => game.status === 'Live' ? 'OPEN LIVE GAME →' : game.detailedState === 'Final' ? 'OPEN BOX SCORE →' : 'VIEW MATCHUP →';
