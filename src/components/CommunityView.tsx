    ...
    try {
      const invoked = await supabase.functions.invoke('community-moderate', {
        body: {
          ...
          targetId,
          decision,
          reason: 'Please review the IXMetrics Community rules before posting again.',
        },
      });
      if (invoked.error) throw invoked.error;
  ...
  return <div className="min-h-screen bg-[#0b1326] text-[#dae2fd] px-3 py-5 sm:px-6 lg:px-8">
    <div className="max-w-6xl mx-auto space-y-6">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <div className="text-[10px] font-label-caps text-[#65f2b5] mb-2">IXMETRICS COMMUNITY</div>
          <h1 className="text-3xl sm:text-4xl font-bold text-[#dbfcff]">Community</h1>
          <p className="text-sm text-[#aebbc8] mt-2 max-w-2xl">Talk baseball, share photos or clips, follow other IXMetrics users, reply to fans, and react to game discussions.</p>
        </div>
