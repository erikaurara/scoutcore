    ...
    <header className="fixed top-0 left-0 right-0 lg:left-72 h-16 bg-[#0b1326]/95 backdrop-blur-xl z-40 border-b border-[#3b494b]/20 flex items-center justify-between px-3 sm:px-4 lg:px-8 select-none">
      <div className="flex items-center gap-2 min-w-0 flex-1">
        ...
        <div className="lg:hidden flex items-center gap-2 min-w-0">
          <img src={LOGO_URL} alt="NineMetrics" className="h-7 w-7 object-contain shrink-0" />
          <div className="min-w-0 leading-none">
            <span className="block font-headline-lg font-bold text-[#dbfcff] truncate text-sm sm:text-base">NineMetrics</span>
            <span className="hidden sm:block mt-0.5 text-[8px] font-label-caps tracking-[0.14em] text-[#00f0ff]">AI GAMEDAY INTELLIGENCE</span>
          </div>
        </div>
